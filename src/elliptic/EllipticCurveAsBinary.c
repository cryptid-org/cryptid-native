...
void ellipticCurveAsBinary_init(
  ...
  memcpy(ellipticCurveAsBinaryOutput->fieldOrder, fieldOrder,
         fieldOrderLength + 1);

  ellipticCurveAsBinaryOutput->fieldOrderLength = fieldOrderLength;
}

void ellipticCurveAsBinary_destroy(
    EllipticCurveAsBinary ellipticCurveAsBinary) {
...
void ellipticCurveAsBinary_toEllipticCurve(
  ...
  mpz_inits(ellipticCurveOutput->a, ellipticCurveOutput->b,
            ellipticCurveOutput->fieldOrder, NULL);

  mpz_import(ellipticCurveOutput->a, ellipticCurveAsBinary.aLength, 1, 1, 0, 0,
             ellipticCurveAsBinary.a);
  mpz_import(ellipticCurveOutput->b, ellipticCurveAsBinary.bLength, 1, 1, 0, 0,
             ellipticCurveAsBinary.b);
  mpz_import(ellipticCurveOutput->fieldOrder,
             ellipticCurveAsBinary.fieldOrderLength, 1, 1, 0, 0,
             ellipticCurveAsBinary.fieldOrder);
}
...
void ellipticCurveAsBinary_fromEllipticCurve(
  ...
  ellipticCurveAsBinaryOutput->a = mpz_export(
      NULL, &ellipticCurveAsBinaryOutput->aLength, 1, 1, 0, 0, ellipticCurve.a);

  ellipticCurveAsBinaryOutput->b = mpz_export(
      NULL, &ellipticCurveAsBinaryOutput->bLength, 1, 1, 0, 0, ellipticCurve.b);

  ellipticCurveAsBinaryOutput->fieldOrder =
      mpz_export(NULL, &ellipticCurveAsBinaryOutput->fieldOrderLength, 1, 1, 0,
                 0, ellipticCurve.fieldOrder);
}