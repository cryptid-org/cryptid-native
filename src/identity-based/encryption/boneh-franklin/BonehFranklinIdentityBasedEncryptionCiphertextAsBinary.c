...
void bonehFranklinIdentityBasedEncryptionCiphertextAsBinary_toBonehFranklinIdentityBasedEncryptionCiphertext(
  ...
  ciphertextOutput->cipherV = (unsigned char *)malloc(ciphertextAsBinary.cipherVLength + 1);
  ...
  ciphertextOutput->cipherW = (unsigned char *)malloc(ciphertextAsBinary.cipherWLength + 1);
