...
int millerrabin_mpz(mpz_srcptr p, int repetitions)
{
...
int millerrabin(mpz_srcptr p, mpz_srcptr pMinus1, mpz_ptr base, mpz_ptr basePow, mpz_srcptr d, unsigned long int s)
{
