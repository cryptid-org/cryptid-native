 ...
 * @param affinePointOutput the AffinePoint to be initialized based on an AffinePointAsBinary
 * @param affinePointAsBinary the AffinePointAsBinary, which needs to be converted to AffinePoint
 */
