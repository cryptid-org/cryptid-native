 ...
 *               evaluated at \f$B\f$. On SUCCESS, this should be destroyed by the caller.
 * @param ec the elliptic curve to operate on
 * @param a a point in \f$E(F_p)\f$
 * @param b a point \f$E(F_p^2)\f$
 ...
 *               \f$A^{\prime\prime}\f$ evaluated at \f$B\f$. On SUCCESS, this should be destroyed by the caller.
 * @param ec the elliptic curve to operate on
 * @param a a point in \f$E(F_p)\f$
