...
/**
 * Initializes a new ComplexAsBinary with the binary representation of specified real and imaginary parts.
 ...
 * @param imaginaryLength the length of the imaginary part's binary representation
 */
void complexAsBinary_init(ComplexAsBinary *complexAsBinaryOutput, const void *const real, const size_t realLength, const void *const imaginary, const size_t imaginaryLength);

/**
 * Frees a ComplexAsBinary. After calling this function on a ComplexAsBinary instance,
 ...
 * @param complexAsBinary the ComplexAsBinary, which needs to be converted to Complex
 */
void complexAsBinary_toComplex(Complex *complexOutput, const ComplexAsBinary complexAsBinary);

/**
 * Converts a Complex to ComplexAsBinary.
 * @param complexAsBinaryOutput the ComplexAsBinary to be initialized based on a Complex
 * @param complex the Complex, which needs to be converted to ComplexAsBinary
 */
void complexAsBinary_fromComplex(ComplexAsBinary *complexAsBinaryOutput, const Complex complex);
